...
CREATE TYPE "premium"."payment_status" AS ENUM('pending', 'confirmed', 'expired', 'failed');--> statement-breakpoint
...
INSERT INTO "premium"."plans" ("id", "version", "name", "price_usd", "duration_days", "max_addresses", "tier", "is_active")
VALUES
