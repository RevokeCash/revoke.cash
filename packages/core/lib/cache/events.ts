...
import type { Events } from './dexie/EventsDexie';
import EventsDexieCache from './dexie/EventsDexieCache';
...
const DO_NOT_INDEX = [ChainId.PulseChain];
...
const eventsCache = new EventsCache(cache);
