import { DAI_PERMIT_ABI } from '@revoke.cash/core/abis';
...
import { type Erc20TokenContract, getPermitDomain } from '@revoke.cash/core/tokens';
...
export const getLastCancelled = async (
  ...
  return blocksCache.getTimeLog(tokenContract.publicClient, lastCancelledEvent.time);
};
