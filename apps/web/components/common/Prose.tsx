...
const Prose = ({ children, className, ...props }: Props) => {
  const classes = twMerge(
    ...
    'prose-h2:text-3xl prose-h2:font-bold prose-h2:m-0 prose-h2:mb-2 prose-h2:font-heading',
    'prose-h3:text-xl prose-h3:font-bold prose-h3:m-0 prose-h3:mb-1 prose-h3:font-heading',
