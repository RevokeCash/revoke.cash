...
description: In the second quarter of 2026, most of our energy went into building the upcoming Revoke Premium and Ultimate plans. Alongside that, we shipped performance optimisations, added a batch of new networks, and published new security content.
date: 2026-06-30
author: Rosco Kalis
...
- [Common Scam: Recovery Scams](/learn/security/crypto-recovery-scams)

We also refreshed our foundational articles on [crypto wallets](/learn/basics/what-is-a-crypto-wallet), [tokens](/learn/basics/what-are-tokens) and [NFTs](/learn/basics/what-are-nfts) to keep them up to date.

## New Exploits

Several new exploits occurred this quarter. We added each one to our [exploits section](/exploits), along with tools to check approvals related to the affected platforms.

- [CoW Swap DNS Hijack](/exploits/cowswap)
- [Ekubo Hack](/exploits/ekubo)
- [Bitmor Hack](/exploits/bitmor)
...
- [Robinhood Chain](/token-approval-checker/robinhood-chain)
- [Tempo](/token-approval-checker/tempo)
- [Citrea](/token-approval-checker/citrea)
- [Igra Network](/token-approval-checker/igra-network)
- [EDU Chain](/token-approval-checker/edu-chain)
- [Matchain](/token-approval-checker/matchain)
- [Reya](/token-approval-checker/reya)
- [Stable](/token-approval-checker/stable)
- [TAC](/token-approval-checker/tac)
- [Gensyn](/token-approval-checker/gensyn)
