...
const DropdownMenu = ({ menuButton, children }: Props) => {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      <Menu.Items className="origin-top-right absolute right-0 mt-2 rounded-lg shadow-lg bg-white border border-black dark:border-white overflow-hidden z-10 flex flex-col focus:outline-none">
        {children}
      </Menu.Items>
    </Menu>
  );
