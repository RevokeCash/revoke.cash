export default function NotCommonBadge() {
  ...
  return (
    <a href="https://not.co/collections/revoke-cash?verify=true" target="_blank" referrerPolicy="origin">
      <img src={src} alt="NotCommon Verified" className="h-9 bg-black rounded-lg border border-white" />
    </a>
  );
}
