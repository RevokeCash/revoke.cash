...
export const getChainExplorerUrl = (chainId: number): string | undefined => {
  const overrides: Record<number, string> = {
    ...
    [ChainId.Merlin]: 'https://scan.merlinchain.io/',
    [ChainId.MerlinTestnet]: 'https://testnet-scan.merlinchain.io',
...
export const getChainRpcUrl = (chainId: number): string | undefined => {
  ...
  const overrides: Record<number, string> = {
    ...
    [ChainId.Merlin]: 'https://rpc.merlinchain.io',
    [ChainId.MerlinTestnet]: 'https://testnet-rpc.merlinchain.io  ',
...
export const getChainLogo = (chainId: number): string => {
  const mapping = {
    ...
    [ChainId.Merlin]: '/assets/images/vendor/chains/merlin.svg',
    [ChainId.MerlinTestnet]: '/assets/images/vendor/chains/merlin.svg',
