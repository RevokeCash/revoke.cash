...
export const getChainName = (chainId: number): string => {
  const overrides: Record<number, string> = {
    ...
    [ChainId.FraxtalTestnet]: 'Fraxtal Holesky',
...
export const getChainExplorerUrl = (chainId: number): string | undefined => {
  const overrides: Record<number, string> = {
    ...
    [ChainId.Beam]: 'https://4337.routescan.io/',
    ...
    [ChainId.ZkSyncMainnet]: 'https://era.zksync.network',
    [ChainId.ZkSyncSepoliaTestnet]: 'https://sepolia-era.zksync.network',
  };
...
export const getChainRpcUrl = (chainId: number): string | undefined => {
  ...
  const overrides: Record<number, string> = {
    ...
    [ChainId.Beam]: 'https://build.onbeam.com/rpc',
    ...
    [ChainId.MerlinMainnet]: 'https://rpc.merlinchain.io',
...
export const getChainLogo = (chainId: number): string => {
  const mapping = {
    ...
    [ChainId.Beam]: '/assets/images/vendor/chains/beam.svg',
    [ChainId.BeamTestnet]: '/assets/images/vendor/chains/beam.svg',
    ...
    [ChainId.Blast]: '/assets/images/vendor/chains/blast.jpg',
    ...
    [ChainId.Fraxtal]: '/assets/images/vendor/chains/fraxtal.svg',
    [ChainId.FraxtalTestnet]: '/assets/images/vendor/chains/fraxtal.svg',
    ...
    [ChainId.MerlinMainnet]: '/assets/images/vendor/chains/merlin.svg',
    [686868]: '/assets/images/vendor/chains/merlin.svg',
...
export const getChainApiUrl = (chainId: number): string | undefined => {
  const apiUrls = {
    ...
    [ChainId['AvalancheC-Chain']]: 'https://api.snowscan.xyz/api',
    [ChainId.AvalancheFujiTestnet]: 'https://api-testnet.snowscan.xyz/api',
    ...
    [ChainId.Blast]: 'https://api.blastscan.io/api',
    [ChainId.BlastSepoliaTestnet]: 'https://api-sepolia.blastscan.io/api',
    ...
    [ChainId.Fraxtal]: 'https://api.fraxscan.com/api',
    [ChainId.FraxtalTestnet]: 'https://api-holesky.fraxscan.com/api',
...
export const getChainDeployedContracts = (chainId: number): any | undefined => {
  ...
  const mapping = {
    ...
    [ChainId.ArbitrumSepolia]: { ...MULTICALL },
    ...
    [ChainId.Fraxtal]: { ...MULTICALL },
    [ChainId.FraxtalTestnet]: { ...MULTICALL },
    ...
    [ChainId.KromaSepolia]: { ...MULTICALL },
    ...
    [ChainId.OPSepoliaTestnet]: { ...MULTICALL },
