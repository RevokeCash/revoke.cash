...
export const CHAINS = {
  ...
  [ChainId.BitrockMainnet]: new Chain({
    ...
    name: 'Bitrock',
    nativeTokenCoingeckoId: 'bitrock',
  ...
  [ChainId.Ethernity]: new Chain({
    ...
    name: 'Ethernity',
    nativeTokenCoingeckoId: 'ethernity-chain',
  ...
  [ChainId.GeistMainnet]: new Chain({
    ...
    name: 'Geist',
    nativeTokenCoingeckoId: 'aavegotchi',
