...
Такие расширения, как [Revoke Extension](https://chrome.google.com/webstore/detail/revokecash/nmniboccheadcclilkfkonokbcoceced) или [Pocket Universe](https://www.pocketuniverse.app/), помогут вам защититься от подобного скама, поскольку они предупреждают, когда вы собираетесь апрувнуть смарт-контракт. Сведение количества апрувов к минимуму и их регулярный [отзыв](/learn/approvals/how-to-revoke-token-approvals) поможет вам защититься, поскольку ограничивает количество ущерба, который может нанести скамер - особенно для объявлений на маркетплейсе.
