...
sidebarTitle: 'Common Scam: Pig Butchering'
description: Pig butchering is a scam that tries to trick you into investing in a fake platform. Learn how pig butchering works and how you can stay safe from it.
...
:::faq-item{question="Can I recover my crypto or money after a pig butchering scam?"}
In most cases, no. Recovering funds is extremely difficult. Cryptocurrency transactions are irreversible and scammers move funds quickly across multiple wallets and platforms.

In rare cases, law enforcement may be able to seize funds if action is taken very quickly and the assets land on a regulated exchange. However, anyone promising a guaranteed recovery for a fee is almost certainly running a second scam.
:::

:::faq-item{question="How do I report a pig butchering scam?"}
If you believe you have been targeted or scammed, report it as soon as possible. Document every interaction (see *What To Do* section in this article).
:::

:::faq-item{question="Is pig butchering illegal?"}
Yes. Pig butchering scams are a form of fraud and are illegal in most jurisdictions.
They typically involve multiple criminal offenses, including investment fraud, wire fraud, identity theft and money laundering. Victims are not at fault for being targeted. The responsibility lies entirely with the scammers.
:::

:::faq-item{question="How can I tell if a crypto trading platform is fake?"}
Fake trading platforms used in pig butchering scams are designed to look professional and convincing. Common warning signs include:

* The platform only exists as a website or app recommended by a private contact
* Profits appear unrealistically consistent or guaranteed
* Withdrawals require additional fees, taxes or security deposits
* The platform cannot be verified through reputable sources or regulators

Legitimate investment platforms do not require secrecy, upfront withdrawal fees or private introductions.
:::

:::faq-item{question="I had a video call with them, is it still a scam?"}
Yes. In recent years, scammers have increasingly used AI deepfakes to bypass video verification.
They can now overlay an attractive person's face and voice onto their own in real-time during live calls. They may also use "short loops" (playing a high-quality video for a few seconds before pretending the connection is bad) to convince you they are real. Never assume a video call equals a verified identity.
:::
