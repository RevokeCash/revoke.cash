...
description: This quarter we launched a collaboration with Pudgy Penguins, made several improvements across the website, attended EthCC in Cannes, and added new networks.
date: 2025-09-30
author: Rosco Kalis
...
We partnered with Pudgy Penguins to create a **Cold Storage SBT**, a non-transferable Soulbound Token that users can claim when they store their assets in a cold wallet.
The goal of the SBT is to encourage safer storage practices and to give users a simple way to prove that they are following good wallet-security habits.
...
- [dTRINITY dLEND Hack](/exploits/dtrinity-dlend)
- [Arcadia Finance Hack](/exploits/arcadia-finance)
- [Fisclend Rug Pull](/exploits/fisclend)
...
- [Plasma](/token-approval-checker/plasma)
- [Katana](/token-approval-checker/katana)
- [Filecoin EVM](/token-approval-checker/filecoin-evm)
- [Hemi](/token-approval-checker/hemi)
- [Somnia](/token-approval-checker/somnia)
- [Somnia Testnet](/token-approval-checker/somnia-testnet)
- [MegaETH Testnet](/token-approval-checker/megaeth-testnet)
- [ZenChain Testnet](/token-approval-checker/zenchain-testnet)
